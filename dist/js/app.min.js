...
(function () {
  ...
  function se() {
    window.innerWidth <= 768 ? (Z.allowTouchMove = !0, Z.params.direction = "horizontal") : (Z.allowTouchMove = !1, Z.params.direction = "vertical"), Z.update();
  }
  ee.forEach(function (e) {
    ...
    e.addEventListener("click", function () {
      t.style.display = "block", s.src = "https://www.youtube.com/embed/__-vp0g_BhA?si=wr9g0o6PIxE_bUTf&amp;controls=0&autoplay=1";

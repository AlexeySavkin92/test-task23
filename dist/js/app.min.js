...
(function () {
      ...
      updateSlides: function updateSlides() {
        ...
        for (var _i6 = 0; _i6 < h; _i6 += 1) {
          ...
          if (I = 0, p[_i6] && (_r2 = p[_i6]), P && e.grid.updateSlide(_i6, _r2, p), !p[_i6] || "none" !== m(_r2, "display")) {
            ...
            } else I = (n - (s.slidesPerView - 1) * y) / s.slidesPerView, s.roundLengths && (I = Math.floor(I)), p[_i6] && (p[_i6].style[e.getDirectionLabel("width")] = "".concat(I, "px"));
            p[_i6] && (p[_i6].swiperSlideSize = I), w.push(I), s.centeredSlides ? (E = E + I / 2 + M / 2 + y, 0 === M && 0 !== _i6 && (E = E - n / 2 - y), 0 === _i6 && (E = E - n / 2 - y), Math.abs(E) < .001 && (E = 0), s.roundLengths && (E = Math.floor(E)), C % s.slidesPerGroup == 0 && f.push(E), v.push(E)) : (s.roundLengths && (E = Math.floor(E)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && f.push(E), v.push(E), E = E + I + y), e.virtualSize += I + y, M = I, C += 1;
          }
        }
        ...
        if (h !== d && e.emit("slidesLengthChange"), f.length !== b && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), v.length !== x && e.emit("slidesGridLengthChange"), s.watchSlidesProgress && e.updateSlidesOffset(), e.emit("slidesUpdated"), !(l || s.cssMode || "slide" !== s.effect && "fade" !== s.effect)) {
  ...
  var L = {
    ...
    A = {
      ...
      loopFix: function loopFix(e) {
        ...
        if (l.__preventObserver__ = !0, requestAnimationFrame(function () {
        ...
        }), l.recalcSlides(), "auto" === f.slidesPerView ? l.updateSlides() : S && (T.length > 0 && E || b.length > 0 && y) && l.slides.forEach(function (e, t) {
          l.grid.updateSlide(t, e, l.slides);
        }), f.watchSlidesProgress && l.updateSlidesOffset(), s) if (T.length > 0 && E) {
          if (void 0 === t) {
            var _e25 = l.slidesGrid[x],
              _t19 = l.slidesGrid[x + M] - _e25;
            o ? l.setTranslate(l.translate - _t19) : (l.slideTo(x + M, 0, !1, !0), r && (l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - _t19, l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - _t19));
          } else if (r) {
          ...
          var _e27 = l.slidesGrid[x],
            _t20 = l.slidesGrid[x - C] - _e27;
          o ? l.setTranslate(l.translate - _t20) : (l.slideTo(x - C, 0, !1, !0), r && (l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - _t20, l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - _t20));
        } else {
  ...
  var R = {
    attachEvents: function attachEvents() {
      var e = this,
        t = e.params;
      e.onTouchStart = G.bind(e), e.onTouchMove = _.bind(e), e.onTouchEnd = D.bind(e), e.onDocumentTouchStart = $.bind(e), t.cssMode && (e.onScroll = B.bind(e)), e.onClick = N.bind(e), e.onLoad = F.bind(e), H(e, "on");
    },
    ...
    _createClass(J, [{
      ...
      value: function init(e) {
        ...
        return t.isElement && s.push.apply(s, _toConsumableArray(t.hostEl.querySelectorAll('[loading="lazy"]'))), s.forEach(function (e) {
          e.complete ? y(t, e) : e.addEventListener("load", function (e) {
            y(t, e.target);
          });

...
(function () {
    ...
    for (var _i = 1; _i < arguments.length; _i += 1) {
      ...
      if (null != _r && (s = _r, !("undefined" != typeof window && void 0 !== window.HTMLElement ? s instanceof HTMLElement : s && (1 === s.nodeType || 11 === s.nodeType)))) {
        ...
        for (var _t = 0, _i2 = _s.length; _t < _i2; _t += 1) {
          ...
          void 0 !== _n && _n.enumerable && (l(e[_i3]) && l(_r[_i3]) ? _r[_i3].__swiper__ ? e[_i3] = _r[_i3] : d(e[_i3], _r[_i3]) : !l(e[_i3]) && l(_r[_i3]) ? (e[_i3] = {}, _r[_i3].__swiper__ ? e[_i3] = _r[_i3] : d(e[_i3], _r[_i3])) : e[_i3] = _r[_i3]);
        }
      }
    }
    var s;
  ...
  var x = function x(e, t) {
    ...
    M = function M(e) {
      ...
      if (e.params.rewind || e.params.loop) for (var _i4 = r - t; _i4 <= n + t; _i4 += 1) {
        var _t3 = (_i4 % s + s) % s;
        (_t3 < r || _t3 > n) && E(e, _t3);
      } else for (var _i5 = Math.max(r - t, 0); _i5 <= Math.min(n + t, s - 1); _i5 += 1) _i5 !== r && (_i5 > n || _i5 < r) && E(e, _i5);
    };
  var C = {
      ...
      updateSlides: function updateSlides() {
        ...
        var s = e.params,
          ...
          p = u(r, ".".concat(e.params.slideClass, ", swiper-slide")),
        ...
        var x = s.spaceBetween,
          ...
          C = 0;
        if (void 0 === n) return;
        "string" == typeof x && x.indexOf("%") >= 0 ? x = parseFloat(x.replace("%", "")) / 100 * n : "string" == typeof x && (x = parseFloat(x)), e.virtualSize = -x, p.forEach(function (e) {
        ...
        for (var _i6 = 0; _i6 < h; _i6 += 1) {
          var _r2 = void 0;
          if (I = 0, p[_i6] && (_r2 = p[_i6]), P && e.grid.updateSlide(_i6, _r2, p), !p[_i6] || "none" !== m(_r2, "display")) {
            if ("auto" === s.slidesPerView) {
              L && (p[_i6].style[e.getDirectionLabel("width")] = "");
              var _n3 = getComputedStyle(_r2),
                _a = _r2.style.transform,
                _o = _r2.style.webkitTransform;
              if (_a && (_r2.style.transform = "none"), _o && (_r2.style.webkitTransform = "none"), s.roundLengths) I = e.isHorizontal() ? g(_r2, "width", !0) : g(_r2, "height", !0);else {
                var _e = t(_n3, "width"),
                ...
                if (_l && "border-box" === _l) I = _e + _a2 + _o2;else {
                  var _r3 = _r2,
                    _t4 = _r3.clientWidth,
                    _n4 = _r3.offsetWidth;
                  I = _e + _s3 + _i7 + _a2 + _o2 + (_n4 - _t4);
                }
              }
              _a && (_r2.style.transform = _a), _o && (_r2.style.webkitTransform = _o), s.roundLengths && (I = Math.floor(I));
            } else I = (n - (s.slidesPerView - 1) * x) / s.slidesPerView, s.roundLengths && (I = Math.floor(I)), p[_i6] && (p[_i6].style[e.getDirectionLabel("width")] = "".concat(I, "px"));
            p[_i6] && (p[_i6].swiperSlideSize = I), w.push(I), s.centeredSlides ? (E = E + I / 2 + M / 2 + x, 0 === M && 0 !== _i6 && (E = E - n / 2 - x), 0 === _i6 && (E = E - n / 2 - x), Math.abs(E) < .001 && (E = 0), s.roundLengths && (E = Math.floor(E)), C % s.slidesPerGroup == 0 && f.push(E), v.push(E)) : (s.roundLengths && (E = Math.floor(E)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && f.push(E), v.push(E), E = E + I + x), e.virtualSize += I + x, M = I, C += 1;
          }
        }
        if (e.virtualSize = Math.max(e.virtualSize, n) + T, a && o && ("slide" === s.effect || "coverflow" === s.effect) && (i.style.width = "".concat(e.virtualSize + x, "px")), s.setWrapperSize && (i.style[e.getDirectionLabel("width")] = "".concat(e.virtualSize + x, "px")), P && e.grid.updateWrapperSize(I, f), !s.centeredSlides) {
          var _t5 = [];
          for (var _i8 = 0; _i8 < f.length; _i8 += 1) {
            var _r4 = f[_i8];
            s.roundLengths && (_r4 = Math.floor(_r4)), f[_i8] <= e.virtualSize - n && _t5.push(_r4);
          }
        ...
        if (l && s.loop) {
          ...
          if (s.slidesPerGroup > 1) {
            ...
            for (var _e2 = 0; _e2 < _i9; _e2 += 1) f.push(f[f.length - 1] + _r5);
          }
          for (var _i10 = 0; _i10 < e.virtual.slidesBefore + e.virtual.slidesAfter; _i10 += 1) 1 === s.slidesPerGroup && f.push(f[f.length - 1] + _t6), v.push(v[v.length - 1] + _t6), e.virtualSize += _t6;
        }
        if (0 === f.length && (f = [0]), 0 !== x) {
          var _t7 = e.isHorizontal() && a ? "marginLeft" : e.getDirectionLabel("marginRight");
          p.filter(function (e, t) {
            return !(s.cssMode && !s.loop) || t !== p.length - 1;
          }).forEach(function (e) {
        ...
        if (Object.assign(e, {
          ...
          c(i, "--swiper-centered-offset-before", -f[0] + "px"), c(i, "--swiper-centered-offset-after", e.size / 2 - w[w.length - 1] / 2 + "px");
        ...
        if (h !== d && e.emit("slidesLengthChange"), f.length !== b && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), v.length !== y && e.emit("slidesGridLengthChange"), s.watchSlidesProgress && e.updateSlidesOffset(), e.emit("slidesUpdated"), !(l || s.cssMode || "slide" !== s.effect && "fade" !== s.effect)) {
          var _t11 = "".concat(s.containerModifierClass, "backface-hidden"),
            _i11 = e.el.classList.contains(_t11);
          h <= s.maxBackfaceHiddenSlides ? _i11 || e.el.classList.add(_t11) : _i11 && e.el.classList.remove(_t11);
        }
      },
      ...
      updateSlidesProgress: function updateSlidesProgress(e) {
        ...
        for (var _e7 = 0; _e7 < i.length; _e7 += 1) {
          ...
          var _c = (a + (s.centeredSlides ? t.minTranslate() : 0) - _d) / (_l2.swiperSlideSize + o),
            ...
            _u = -(a - _d),
            _h = _u + t.slidesSizesGrid[_e7],
            _f = _u >= 0 && _u <= t.size - t.slidesSizesGrid[_e7];
          (_u >= 0 && _u < t.size - 1 || _h > 1 && _h <= t.size || _u <= 0 && _h >= t.size) && (t.visibleSlides.push(_l2), t.visibleSlidesIndexes.push(_e7), i[_e7].classList.add(s.slideVisibleClass)), _f && i[_e7].classList.add(s.slideFullyVisibleClass), _l2.progress = r ? -_c : _c, _l2.originalProgress = r ? -_p : _p;
        }
      },
      ...
      updateSlidesClasses: function updateSlidesClasses() {
        var e = this,
          ...
          o = function o(e) {
            return u(i, ".".concat(s.slideClass).concat(e, ", swiper-slide").concat(e))[0];
          };
        var l, d, c;
      ...
      updateActiveIndex: function updateActiveIndex(e) {
        ...
        if (t.virtual && r.virtual.enabled && r.loop) u = c(d);else if (p) {
          ...
          Number.isNaN(_s8) && (_s8 = Math.max(t.slides.indexOf(_e10), 0)), u = Math.floor(_s8 / r.grid.rows);
        } else if (t.slides[d]) {
          var _e11 = t.slides[d].getAttribute("data-swiper-slide-index");
          u = _e11 ? parseInt(_e11, 10) : d;
        } else u = d;
        Object.assign(t, {
          previousSnapIndex: o,
          snapIndex: l,
  ...
  var L = {
    ...
    k = {
        ...
        if (o.cssMode) {
          ...
          if (0 === t) {
            ...
            _t14 && (n.wrapperEl.style.scrollSnapType = "none", n._immediateVirtual = !0), _t14 && !n._cssModeVirtualInitialSet && n.params.initialSlide > 0 ? (n._cssModeVirtualInitialSet = !0, requestAnimationFrame(function () {
              f[_e15 ? "scrollLeft" : "scrollTop"] = _s10;
            })) : f[_e15 ? "scrollLeft" : "scrollTop"] = _s10, _t14 && requestAnimationFrame(function () {
            ...
            f.scrollTo(_defineProperty(_defineProperty({}, _e15 ? "left" : "top", _s10), "behavior", "smooth"));
          }
          return !0;
        }
      ...
      slidePrev: function slidePrev(e, t, s) {
        ...
        if (void 0 === f && r.cssMode) {
          ...
          n.forEach(function (t, s) {
            u >= t && (_e18 = s);
          }), void 0 !== _e18 && (f = n[_e18 > 0 ? _e18 - 1 : _e18]);
        }
        var m = 0;
      ...
      slideToClickedSlide: function slideToClickedSlide() {
        ...
        if (t.loop) {
          ...
          r = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? n < e.loopedSlides - i / 2 || n > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), n = e.getSlideIndex(u(s, "".concat(o, "[data-swiper-slide-index=\"").concat(r, "\"]"))[0]), a(function () {
            e.slideTo(n);
          })) : e.slideTo(n) : n > e.slides.length - i ? (e.loopFix(), n = e.getSlideIndex(u(s, "".concat(o, "[data-swiper-slide-index=\"").concat(r, "\"]"))[0]), a(function () {
            e.slideTo(n);
          })) : e.slideTo(n);
        } else e.slideTo(n);
      }
    ...
    A = {
      loopCreate: function loopCreate(e) {
        ...
        var r = function r() {
            u(i, ".".concat(s.slideClass, ", swiper-slide")).forEach(function (e, t) {
      ...
      loopFix: function loopFix(e) {
        ...
        "auto" === v ? v = l.slidesPerViewDynamic() : (v = Math.ceil(parseFloat(f.slidesPerView, 10)), m && v % 2 == 0 && (v += 1));
        var g = f.slidesPerGroupAuto ? v : f.slidesPerGroup;
        var w = g;
        w % g != 0 && (w += g - w % g), w += f.loopAdditionalSlides, l.loopedSlides = w;
        var S = l.grid && f.grid && f.grid.rows > 1;
        ...
        var M = 0,
          C = 0;
        var P = S ? Math.ceil(d.length / f.grid.rows) : d.length,
          I = (S ? d[n].column : n) + (m && void 0 === r ? -v / 2 + .5 : 0);
        if (I < w) {
          M = Math.max(w - I, g);
          for (var _e22 = 0; _e22 < w - I; _e22 += 1) {
        ...
        if (l.__preventObserver__ = !0, requestAnimationFrame(function () {
        ...
        }), l.recalcSlides(), "auto" === f.slidesPerView ? l.updateSlides() : S && (T.length > 0 && E || b.length > 0 && x) && l.slides.forEach(function (e, t) {
          l.grid.updateSlide(t, e, l.slides);
        }), f.watchSlidesProgress && l.updateSlidesOffset(), s) if (T.length > 0 && E) {
          if (void 0 === t) {
            ...
            var _e26 = S ? T.length / f.grid.rows : T.length;
          ...
          var _e28 = S ? b.length / f.grid.rows : b.length;
  ...
  function _(e) {
    ...
    if ("touchstart" === r.type) return void z(t, r, r.targetTouches[0].pageX);
    var l = t.params,
      d = t.touches,
      c = t.enabled;
    if (!c) return;
  ...
  function G(e) {
    ...
    if (void 0 === r.isScrolling) {
      var _e30;
      s.isHorizontal() && a.currentY === a.startY || s.isVertical() && a.currentX === a.startX ? r.isScrolling = !1 : f * f + m * m >= 25 && (_e30 = 180 * Math.atan2(Math.abs(m), Math.abs(f)) / Math.PI, r.isScrolling = s.isHorizontal() ? _e30 > n.touchAngle : 90 - _e30 > n.touchAngle);
    }
    ...
    var b = !0,
      y = n.resistanceRatio;
    if (n.touchReleaseOnEdges && (y = 0), v > 0 ? (S && T && r.allowThresholdMove && r.currentTranslate > (n.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] : s.minTranslate()) && s.loopFix({
      direction: "prev",
      setTranslate: !0,
      activeSlideIndex: 0
    }), r.currentTranslate > s.minTranslate() && (b = !1, n.resistance && (r.currentTranslate = s.minTranslate() - 1 + Math.pow(-s.minTranslate() + r.startTranslate + v, y)))) : v < 0 && (S && T && r.allowThresholdMove && r.currentTranslate < (n.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] : s.maxTranslate()) && s.loopFix({
      direction: "next",
      setTranslate: !0,
      activeSlideIndex: s.slides.length - ("auto" === n.slidesPerView ? s.slidesPerViewDynamic() : Math.ceil(parseFloat(n.slidesPerView, 10)))
    }), r.currentTranslate < s.maxTranslate() && (b = !1, n.resistance && (r.currentTranslate = s.maxTranslate() + 1 - Math.pow(s.maxTranslate() - r.startTranslate - v, y)))), b && (p.preventedByNestedSwiper = !0), !s.allowSlideNext && "next" === s.swipeDirection && r.currentTranslate < r.startTranslate && (r.currentTranslate = r.startTranslate), !s.allowSlidePrev && "prev" === s.swipeDirection && r.currentTranslate > r.startTranslate && (r.currentTranslate = r.startTranslate), s.allowSlidePrev || s.allowSlideNext || (r.currentTranslate = r.startTranslate), n.threshold > 0) {
  ...
  function D(e) {
    ...
    if (t.allowClick) {
      ...
      t.updateClickedSlide(_e32 && _e32[0] || r.target, _e32), t.emit("tap click", r), h < 300 && u - s.lastClickTime < 300 && t.emit("doubleTap doubleClick", r);
    }
    ...
    for (var _e33 = 0; _e33 < c.length; _e33 += _e33 < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
      ...
      void 0 !== c[_e33 + _t21] ? (m || f >= c[_e33] && f < c[_e33 + _t21]) && (v = _e33, g = c[_e33 + _t21] - c[_e33]) : (m || f >= c[_e33]) && (v = _e33, g = c[c.length - 1] - c[c.length - 2]);
    }
    var w = null,
      S = null;
  ...
  var H = function H(e, t) {
    ...
    s[d]("touchstart", e.onDocumentTouchStart, {
      ...
      passive: !0
    }), (r.preventClicks || r.preventClicksPropagation) && n[d]("click", e.onClick, !0), r.cssMode && a[d]("scroll", e.onScroll), r.updateOnWindowResize ? e[c](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", V, !0) : e[c]("observerUpdate", V, !0), n[d]("load", e.onLoad, {
      capture: !0
    });
  };
  var R = {
    attachEvents: function attachEvents() {
      var e = this,
        t = e.params;
      e.onTouchStart = _.bind(e), e.onTouchMove = G.bind(e), e.onTouchEnd = D.bind(e), e.onDocumentTouchStart = $.bind(e), t.cssMode && (e.onScroll = B.bind(e)), e.onClick = N.bind(e), e.onLoad = F.bind(e), H(e, "on");
    },
  ...
  var J = /*#__PURE__*/function () {
    function J() {
      var _r8, _r9, _l$modules;
      _classCallCheck(this, J);
      var e, t;
      for (var s = arguments.length, r = new Array(s), a = 0; a < s; a++) r[a] = arguments[a];
      1 === r.length && r[0].constructor && "Object" === Object.prototype.toString.call(r[0]).slice(8, -1) ? t = r[0] : (_r8 = r, _r9 = _slicedToArray(_r8, 2), e = _r9[0], t = _r9[1], _r8), t || (t = {}), t = d({}, t), e && !t.el && (t.el = e);
      var o = i();
      ...
      var l = this;
      var c;
      l.__swiper__ = !0, l.support = b(), l.device = (void 0 === (c = {
        ...
        if (s()) {
          ...
          if (_s13.includes("Version/")) {
            var _s13$split$1$split$0$ = _s13.split("Version/")[1].split(" ")[0].split(".").map(function (e) {
              ...
              _i20 = _s13$split$1$split$0$2[1];
            t = _e36 < 16 || 16 === _e36 && _i20 < 2;
          }
        }
        return {
          isSafari: t || s(),
      ...
      }()), T), l.eventsListeners = {}, l.eventsAnyListeners = [], l.modules = _toConsumableArray(l.__modules__), t.modules && Array.isArray(t.modules) && (_l$modules = l.modules).push.apply(_l$modules, _toConsumableArray(t.modules));
      var p = {};
      ...
      var u = d({}, Y, p);
      return l.params = d({}, u, K, t), l.originalParams = d({}, l.params), l.passedParams = d({}, t), l.params && l.params.on && Object.keys(l.params.on).forEach(function (e) {
    ...
    _createClass(J, [{
      ...
      value: function getSlideIndex(e) {
        var t = this.slidesEl,
          s = this.params,
          i = v(u(t, ".".concat(s.slideClass, ", swiper-slide"))[0]);
        return v(e) - i;
      }
    }, {
      ...
      value: function recalcSlides() {
        var e = this.slidesEl,
          t = this.params;
        this.slides = u(e, ".".concat(t.slideClass, ", swiper-slide"));
      }
    }, {
      key: "enable",
      ...
      value: function mount(e) {
        ...
        var r = s && s.shadowRoot && s.shadowRoot.querySelector ? s.shadowRoot.querySelector(i()) : u(s, i())[0];
        return !r && t.params.createElements && (r = f("div", t.params.wrapperClass), s.append(r), u(s, ".".concat(t.params.slideClass)).forEach(function (e) {
          r.append(e);
        })), Object.assign(t, {
          el: s,
          wrapperEl: r,
      ...
      value: function init(e) {
        ...
        return t.isElement && s.push.apply(s, _toConsumableArray(t.hostEl.querySelectorAll('[loading="lazy"]'))), s.forEach(function (e) {
          e.complete ? x(t, e) : e.addEventListener("load", function (e) {
            x(t, e.target);
          });
  ...
  var Q = new J(".swiper-container", {
    ...
    Z = document.querySelectorAll(".slide-button");
  function ee(e) {
    Z.forEach(function (e) {
      e.classList.remove("active");
    }), Z[e].classList.add("active");
  }
  Z.forEach(function (e) {
    ...
    var e = document.querySelector(".videoSection__custom-button"),
      ...
      s = (document.querySelector(".videoSection__iframe"), document.querySelector(".video-popup__iframe"));
    e.addEventListener("click", function () {
